    ...
    <div className='border-b border-primary text-base '>
      ...
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example" className='text-primary' indicatorColor="primary" sx={{width:'100%'}}>
          <Tab label="Description" {...a11yProps(0)}  className='text-primary md:text-base text-[11px] font-semibold w-[33.3%] px-0' sx={{fontSize:'0'}} />
          <Tab label="Specification" {...a11yProps(1)}  className='text-primary md:text-base text-[11px] font-semibold w-[33.3%] px-0' sx={{fontSize:'0'}}/>
          <Tab label="Spec in Pictures" {...a11yProps(2)}  className='text-primary md:text-base text-[11px] font-semibold w-[33.3%] px-0' sx={{fontSize:'0'}}/>
        </Tabs>
      </Box>
