        ...
        <div className=' flex justify-between '>
          <div className='left flex flex-col md:flex-row gap-2'>
            ...
            <div className='flex flex-col  self-end'>
              ...
              <p className='md:text-xl text-sm font-semibold text-heading'> &#x20A6; {item.price}</p>
            </div>
          </div>
            <div className='right flex flex-col justify-between '>
                ...
                <div className='flex  justify-center items-center bg-black bg-opacity-[0.08] py-2 px-3 rounded-2xl'>
                  <button className='text-white bg-primary rounded-full flex justify-center items-center'><RemoveIcon fontSize='small'/></button>
                  <p className='md:mx-2 mx-1'>1</p>
                  <button className='text-white bg-primary rounded-full flex justify-center items-center'><AddIcon fontSize='small'/></button>
                </div>
            </div>
        </div>
    </section>
